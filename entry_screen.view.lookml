...
#     sql: ${TABLE}.benefits_noncash
  ...
  - dimension: chronic_homeless_calculation
    ...
    sql: |
      ...
      ( ${TABLE}.chronic_6 = 1 OR  ${programs.ref_category} IN (1,4,8))
      AND (TIMESTAMPDIFF(DAY,${TABLE}.chronic_7,${enrollments.start_date}) >=365 OR
      ${TABLE}.chronic_2 =4 AND ${TABLE}.chronic_3 IN (112,113))
